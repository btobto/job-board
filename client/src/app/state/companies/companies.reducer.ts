...
export const companiesReducer = createReducer(
  initialState,
  on(
    companiesActions.loadCompany,
    companiesActions.searchCompanies,
    companiesActions.getHighestRatedCompanies,
  ...
  on(
    ...
    companiesActions.getHighestRatedCompaniesFailure,
    (state, { error }) => ({
      ...state,
      selectedCompanyId: null,
      loading: false,
  ...
  on(
    ...
    companiesActions.getHighestRatedCompaniesSuccess,
    (state, { companies }) => companiesAdapter.setAll(companies, { ...state, loading: false, selectedCompanyId: null })
  ),
